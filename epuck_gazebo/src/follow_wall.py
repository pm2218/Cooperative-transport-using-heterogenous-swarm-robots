...
def take_action():
    ...
    if regions['front'] > d and regions['fleft'] > d and regions['fright'] > d:
        ...
        state_description = 'case 9 - front and fright and right'
        change_state(1)
    elif regions['front'] > d and regions['fleft'] > d and regions['fright'] < d and regions['right'] < d:
        state_description = 'case 10 - fright and right'
        change_state(1)
    elif regions['front'] > d and regions['fleft'] > d and regions['fright'] < d and regions['right'] > d:
        state_description = 'case 11 - fright'
        change_state(1)
    else:
...
def main():
    ...
    srv = rospy.Service(robot_name + '/wall_follower_switch', SetBool, wall_follower_switch)
